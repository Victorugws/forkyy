...
import StatisticCard from '@/components/banking/StatisticCard'
import RecentActivity from '@/components/banking/RecentActivity'
import ExchangeCard from '@/components/banking/ExchangeCard'
...
export default function BankingPage() {
  ...
  // Create a minimal tab for this page
  ...
  // Handle hash navigation to finance section
  useEffect(() => {
    if (window.location.hash === '#finance-section') {
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      ...
      <div className="fixed top-[40px] left-0 right-0 z-50 flex flex-col flex-shrink-0">
        ...
        {/* Prompt Suggestions Ticker - Below Browser Bar */}
      ...
      <div className="flex flex-row min-h-screen relative z-10">
        <BankingSidebar />
        <main className="flex-1 h-screen relative ml-24">
          <div className="absolute top-[140px] left-0 right-0 bottom-0 overflow-y-auto">
            <div className="max-w-[1440px] mx-auto w-full min-h-full bg-white/40 backdrop-blur-lg rounded-t-2xl border border-[#e6ebf3] p-6 pb-8">
              {/* Top Row: Account Card and Balance Card */}
              ...
              {/* Finance/News Section - Scrollable Content */}
              <div id="finance-section" className="mt-12 pt-8 border-t border-[#e6ebf3]">
                <FinancePageContent />
              </div>
            </div>
          </div>
      ...
      {/* Search Tab - Positioned at bottom */}
      {!showSuggestions && (
        <div
