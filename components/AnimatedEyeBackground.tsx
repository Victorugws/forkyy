    ...
    return (
        ...
        .eye::before {
          ...
          background:
            conic-gradient(
              from 0deg,
              rgba(180, 180, 180, 0.6) 0deg 5deg,
              transparent 5deg 10deg,
              rgba(180, 180, 180, 0.6) 10deg 15deg,
              transparent 15deg 20deg,
              rgba(180, 180, 180, 0.6) 20deg 25deg,
              transparent 25deg 30deg,
              rgba(180, 180, 180, 0.6) 30deg 35deg,
              transparent 35deg 40deg,
              rgba(180, 180, 180, 0.6) 40deg 45deg,
              transparent 45deg 50deg,
              rgba(180, 180, 180, 0.6) 50deg 55deg,
              transparent 55deg 60deg,
              rgba(180, 180, 180, 0.6) 60deg 65deg,
              transparent 65deg 70deg,
              rgba(180, 180, 180, 0.6) 70deg 75deg,
              transparent 75deg 80deg,
              rgba(180, 180, 180, 0.6) 80deg 85deg,
              transparent 85deg 90deg,
              rgba(180, 180, 180, 0.6) 90deg 95deg,
              transparent 95deg 100deg,
              rgba(180, 180, 180, 0.6) 100deg 105deg,
              transparent 105deg 110deg,
              rgba(180, 180, 180, 0.6) 110deg 115deg,
              transparent 115deg 120deg,
              rgba(180, 180, 180, 0.6) 120deg 125deg,
              transparent 125deg 130deg,
              rgba(180, 180, 180, 0.6) 130deg 135deg,
              transparent 135deg 140deg,
              rgba(180, 180, 180, 0.6) 140deg 145deg,
              transparent 145deg 150deg,
              rgba(180, 180, 180, 0.6) 150deg 155deg,
              transparent 155deg 160deg,
              rgba(180, 180, 180, 0.6) 160deg 165deg,
              transparent 165deg 170deg,
              rgba(180, 180, 180, 0.6) 170deg 175deg,
              transparent 175deg 180deg,
              rgba(180, 180, 180, 0.6) 180deg 185deg,
              transparent 185deg 190deg,
              rgba(180, 180, 180, 0.6) 190deg 195deg,
              transparent 195deg 200deg,
              rgba(180, 180, 180, 0.6) 200deg 205deg,
              transparent 205deg 210deg,
              rgba(180, 180, 180, 0.6) 210deg 215deg,
              transparent 215deg 220deg,
              rgba(180, 180, 180, 0.6) 220deg 225deg,
              transparent 225deg 230deg,
              rgba(180, 180, 180, 0.6) 230deg 235deg,
              transparent 235deg 240deg,
              rgba(180, 180, 180, 0.6) 240deg 245deg,
              transparent 245deg 250deg,
              rgba(180, 180, 180, 0.6) 250deg 255deg,
              transparent 255deg 260deg,
              rgba(180, 180, 180, 0.6) 260deg 265deg,
              transparent 265deg 270deg,
              rgba(180, 180, 180, 0.6) 270deg 275deg,
              transparent 275deg 280deg,
              rgba(180, 180, 180, 0.6) 280deg 285deg,
              transparent 285deg 290deg,
              rgba(180, 180, 180, 0.6) 290deg 295deg,
              transparent 295deg 300deg,
              rgba(180, 180, 180, 0.6) 300deg 305deg,
              transparent 305deg 310deg,
              rgba(180, 180, 180, 0.6) 310deg 315deg,
              transparent 315deg 320deg,
              rgba(180, 180, 180, 0.6) 320deg 325deg,
              transparent 325deg 330deg,
              rgba(180, 180, 180, 0.6) 330deg 335deg,
              transparent 335deg 340deg,
              rgba(180, 180, 180, 0.6) 340deg 345deg,
              transparent 345deg 350deg,
              rgba(180, 180, 180, 0.6) 350deg 355deg,
            ...
            radial-gradient(
              ...
              transparent 0%,
              transparent 43%,
              rgba(190, 190, 190, 0.5) 43%,
              rgba(200, 200, 200, 0.6) 48%,
              rgba(210, 210, 210, 0.7) 50%,
              rgba(200, 200, 200, 0.6) 52%,
              rgba(190, 190, 190, 0.5) 57%,
              transparent 57%,
              transparent 100%
            );
